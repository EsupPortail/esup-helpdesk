...
<e:page stringsVar="msgs" menuItem="statistics"
	locale="#{sessionController.locale}">
	<%@include file="_navigation.jsp"%>

	<script type="text/javascript">
	function selectTicket(index) {
		simulateLinkClick('statisticsForm:ticketsData:' + index + ':selectTicketButton');
		simulateLinkClick('statisticsForm:ticketsData:' + index + ':selectArchivedTicketButton');
	}
</script>
	...
	<e:form 
		...
		<e:section value="#{msgs['STATISTICS.TITLE']}" />
		<e:messages />
	...
	<t:aliasBean alias="#{controller}" value="#{statisticsController}" >
