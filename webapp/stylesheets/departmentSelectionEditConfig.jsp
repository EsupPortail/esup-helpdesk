...
<e:page stringsVar="msgs"  menuItem="departmentSelection" locale="#{sessionController.locale}" authorized="#{departmentSelectionController.currentUserCanEditDepartmentSelection}" >
 <t:htmlTag id="departmentSelectionEditConfig" value="div" styleClass="page-wrapper departmentSelectionEditConfig">
                                    ...
                                    id="departmentSelectionEditForm" >
                                         ...
                                         <t:htmlTag value="div" styleClass="controlPanel-title">
                                             <t:htmlTag value="h1">
                                                 <t:htmlTag value="span">
                                                     <h:outputText value="#{msgs['DEPARTMENT_SELECTION_EDIT.CONFIG_TITLE']}"/>
                                                 </t:htmlTag>
                                             </t:htmlTag>
                                         </t:htmlTag>
                                      </t:htmlTag>
                                      <t:htmlTag value="div" styleClass="message">
                                        ...
                                        <e:panelGrid columns="2" width="100%" columnClasses="colLeft,colLeftMax">
                                            <e:panelGrid columns="2" width="100%" columnClasses="colLeft,colRightNowrap">
                                                <h:panelGroup>
                                                    <h:panelGroup style="cursor: pointer" onclick="simulateLinkClick('departmentSelectionEditForm:updateConfigButton');" >
                                                    ...
                                                    <e:commandButton style="display:none"
                                                        id="updateConfigButton" action="#{departmentSelectionController.doEditConfig}"
                                            ...
                                            <h:panelGroup>
                                                <%@include file="_departmentSelectionEditHelp.jsp"%>
                                            </h:panelGroup>
                                        </e:panelGrid>
