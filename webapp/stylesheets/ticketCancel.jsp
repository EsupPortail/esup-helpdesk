...
<e:page stringsVar="msgs" menuItem=""
	...
	authorized="#{ticketController.userCanCancel}">
		   <t:htmlTag id="ticketCancel" value="div" styleClass="page-wrapper ticketCancel">
                                ...
                                <t:htmlTag value="div" styleClass="ticket-form">
                                    <t:htmlTag value="div" styleClass="form-block form-header">
                                        <t:htmlTag value="h1">
                                            <t:htmlTag value="span" styleClass="title">
                                                  <h:outputText value="#{msgs['TICKET_ACTION.TITLE.CANCEL']}" escape="false" />
                                            </t:htmlTag>
                                    ...
                                    <t:htmlTag value="div" styleClass="form-block form-body">
                                        <t:htmlTag value="div" styleClass="form-item">
                                            <e:outputLabel for="actionMessage" value=" #{msgs['TICKET_ACTION.TEXT.CANCEL']}"/>
                                            <fck:editor
                                                id="actionMessage"
                                    ...
                                    <t:htmlTag value="div" styleClass="form-block">
                                        <t:htmlTag value="div" styleClass="form-item display-flex" >
                                            <e:commandButton id="actionButton"
                                                    ...
                                                    value="#{msgs['TICKET_ACTION.BUTTON.CANCEL']}"
                                                    action="#{ticketController.doCancel}" />
