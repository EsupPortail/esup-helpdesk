...
<e:page stringsVar="msgs" menuItem=""
	...
	authorized="#{ticketController.userCanApproveClosure}">
		   ...
		   <t:htmlTag id="ticketApproveClosure" value="div" styleClass="page-wrapper ticketApproveClosure">
                                ...
                                <t:htmlTag value="div" styleClass="ticket-form">
                                    <t:htmlTag value="div" styleClass="form-block form-header">
                                        <t:htmlTag value="h1">
                                            <t:htmlTag value="span" styleClass="title">
                                                  <h:outputText value="#{msgs['TICKET_ACTION.TITLE.APPROVE_CLOSURE']}" escape="false" />
                                            </t:htmlTag>
                                    ...
                                    <t:htmlTag value="div" styleClass="form-block form-body">
                                        <t:htmlTag value="div" styleClass="form-item">
                                                <e:outputLabel for="actionMessage" value=" #{msgs['TICKET_ACTION.TEXT.APPROVE_CLOSURE']}"/>
                                                <fck:editor
                                                id="actionMessage"
