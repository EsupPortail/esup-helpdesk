...
<e:page stringsVar="msgs" menuItem=""
	...
	authorized="#{ticketController.userCanGiveInformation}">
		   <t:htmlTag id="ticketUpdateInformation" value="div" styleClass="page-wrapper ticketUpdateInformation">
                                    ...
                                    <t:htmlTag value="div" styleClass="form-block form-header">
                                        <t:htmlTag value="h1">
                                            <t:htmlTag value="span" styleClass="title">
                                                  <h:outputText value="#{msgs['TICKET_ACTION.TITLE.UPDATE_INFORMATION']}" escape="false" />
                                            </t:htmlTag>
