...
<e:page stringsVar="msgs" menuItem=""
	...
	authorized="#{ticketController.userCanDeleteFileInfo}">
		   <t:htmlTag id="ticketDeleteAttachment" value="div" styleClass="page-wrapper ticketDeleteAttachment">
                                    ...
                                    <t:htmlTag value="div" styleClass="form-block form-header">
                                        <t:htmlTag value="h1">
                                            <t:htmlTag value="span" styleClass="title">
                                                  <h:outputText value="#{msgs['TICKET_ACTION.TITLE.DELETE_ATTACHMENT']}" escape="false" />
                                            </t:htmlTag>
                                        ...
                                        <t:htmlTag value="h2">
                                            <t:htmlTag value="span" styleClass="title">
                                                  <h:outputText value="#{msgs['TICKET_ACTION.TEXT.DELETE_ATTACHMENT.FILE.LABEL']}" escape="false" />
                                            </t:htmlTag>
                                            <t:htmlTag value="span" styleClass="subtitle">
                                                <h:outputText value=" #{ticketController.fileInfoToDelete.filename}" escape="false" />
                                            </t:htmlTag>
                                        </t:htmlTag>
                                    </t:htmlTag>
