...
<e:panelGrid columns="2" columnClasses="colfLeftNowrap,colLeft" >
	...
	<t:htmlTag value="pre"><f:verbatim escape="true"><add-by-cate label="</f:verbatim><e:italic value="#{msgs['DEPARTMENT_SELECTION_EDIT_HELP.TEXT.ACTION_ADD_BY_LABEL']}" /><f:verbatim escape="true">" visible="</f:verbatim><e:italic value="true/false" /><f:verbatim escape="true">" cateIds="</f:verbatim><e:italic value="#{msgs['DEPARTMENT_SELECTION_EDIT_HELP.TEXT.ACTION_CATE_PARAM']}" /><f:verbatim escape="true">"/></f:verbatim></t:htmlTag>
