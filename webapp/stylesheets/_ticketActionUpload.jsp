...
<t:htmlTag id="ticketFiles" value="div" styleClass=" block accordion accordion-plus">

    <t:htmlTag value="h2">
            <t:htmlTag value="span"><h:outputText value="#{msgs['TICKET_ACTION.BUTTON.ADD.FILES']}" escape="false" /></t:htmlTag>
        ...
        <e:dataTable
            ...
            <t:column>
                <h:panelGroup styleClass="cursor--pointer"
                            onclick="simulateLinkClick('ticketActionForm:tempUploadedFileData:#{index}:deleteUploadedFileButton');">
