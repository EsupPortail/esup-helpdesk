...
<e:page stringsVar="msgs" menuItem=""
	...
	authorized="#{ticketController.userCanFree}">
		   <t:htmlTag id="ticketFree" value="div" styleClass="page-wrapper ticketFree">
                            ...
                            id="ticketActionForm" enctype="multipart/form-data" >
                                ...
                                <t:htmlTag value="div" styleClass="ticket-form">
                                    <t:htmlTag value="div" styleClass="form-block form-header">
                                        <t:htmlTag value="h1">
                                            <t:htmlTag value="span" styleClass="title">
                                                  <h:outputText value="#{msgs['TICKET_ACTION.TITLE.FREE']}" escape="false" />
                                            </t:htmlTag>
                                    ...
                                    <t:htmlTag value="div" styleClass="form-block form-body">
                                        <t:htmlTag value="div" styleClass="form-item">
                                            <e:outputLabel for="actionMessage" value=" #{msgs['TICKET_ACTION.TEXT.FREE']}"/>
                                            <fck:editor
                                                id="actionMessage"
                                ...
                                <t:htmlTag styleClass="region extended-properties" value="div">
                                            <t:htmlTag styleClass="tabs" value="ul">
                                                ...
                                                <t:htmlTag id="history" styleClass="tab-link #{!departmentsController.currentUserCanViewDepartments && !departmentsController.currentUserCanViewDepartments ? 'current' :''}" value="li">
                                ...
                                <t:htmlTag id="tab-history" styleClass="tab-content view-ticket_history #{!departmentsController.currentUserCanViewDepartments && !departmentsController.currentUserCanViewDepartments? 'current' :''}" value="div">
