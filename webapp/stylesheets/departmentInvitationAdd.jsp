...
<e:page stringsVar="msgs" menuItem="departments"
	...
	authorized="#{departmentsController.currentUserCanManageDepartmentManagers}">
		  <t:htmlTag id="departmentInvitationAdd" value="div" styleClass="page-wrapper departmentInvitationAdd">
                                         ...
                                         <t:htmlTag value="div" styleClass="controlPanel-title">
                                             <t:htmlTag value="h1">
                                                 <t:htmlTag value="span">
                                                     <h:outputText value="#{msgs['DEPARTMENT_INVITATION_ADD.TITLE']}"/>
                                                 </t:htmlTag>
                                      ...
                                      <t:htmlTag value="div" styleClass="form-block utils-ldapuid">
                                                         ...
                                                         <t:htmlTag value="div" styleClass="form-item " >
                                                          ...
                                                          <t:htmlTag value="div" styleClass="form-item form-submit" >
                                                                <e:commandButton id="addButton" action="#{departmentsController.addDepartmentInvitation}"
                                                                    value="#{msgs['DEPARTMENT_INVITATION_ADD.BUTTON.ADD_DEPARTMENT_INVITATION']}" styleClass="button--primary" />
