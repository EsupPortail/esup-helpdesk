...
<e:page stringsVar="msgs" menuItem=""
	...
	authorized="#{ticketController.userCanCancelPostponement}">
		   ...
		   <t:htmlTag id="ticketCancelPostponement" value="div" styleClass="page-wrapper ticketCancelPostponement">
                                  ...
                                  <t:htmlTag value="div" styleClass="ticket-form">
                                      <t:htmlTag value="div" styleClass="form-block form-header">
                                          <t:htmlTag value="h1">
                                              <t:htmlTag value="span" styleClass="title">
                                                    <h:outputText value="#{msgs['TICKET_ACTION.TITLE.CANCEL_POSTPONEMENT']}" escape="false" />
                                              </t:htmlTag>
                                      ...
                                      <t:htmlTag value="div" styleClass="form-block form-body">
                                            <t:htmlTag value="div" styleClass="form-item">
                                                    <e:outputLabel for="actionMessage" value=" #{msgs['TICKET_ACTION.TEXT.CANCEL_POSTPONEMENT']}"/>
                                                    <fck:editor
                                                    id="actionMessage"
