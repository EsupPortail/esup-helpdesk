 ...
 */
public interface LdapStructureService extends BasicLdapService {
	 ...
	 */
	LdapStructure getLdapStructure(String id) throws LdapException, UserNotFoundException;
	 ...
	 * @throws LdapException
	 */
	boolean structureMatchesFilter(String id, String filter) throws LdapException;
	 ...
	 * @throws LdapException 
	 */
	List<LdapStructure> getLdapStructuresFromToken(String token) throws LdapException;
	 ...
	 * @throws LdapException 
	 */
	List<LdapStructure> getLdapStructuresFromFilter(String filterExpr) throws LdapException;
